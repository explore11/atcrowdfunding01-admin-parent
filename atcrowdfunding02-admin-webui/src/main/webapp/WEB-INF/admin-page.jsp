...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        var properties = {
            ...
            items_per_page:${requestScope.pageInfo.pageSize},//每页显示个数
            current_page: ${requestScope.pageInfo.pageNum-1}, //当前页数  默认是从0开始的，即0就是第一页
            prev_text: "上一页",
            next_text: "下一页",
        };
        //生成页码导航条
    ...
    //回调函数  当用户点击上一页下一页 1.2.3....这样的页码时来调用这个函数实现页面跳转
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <%--                    </button>--%>
                    <a class="btn btn-primary" style="float:right;" href="admin/add/page.html">
                    ...
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                            <%--如果查询到pageInfo中没有数据  则返回提示信息--%>
                            <c:if test="${empty requestScope.pageInfo.list}">
                                <tr>
                                    <td colspan="6">抱歉！没有你要查询的数据</td>
                                </tr>
                            </c:if>
                            ...
                            <c:if test="${!empty requestScope.pageInfo.list}">
                                <c:forEach items="${requestScope.pageInfo.list}" var="admin" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>${admin.email}</td>
                                        <td>
                                            <a href="admin/add/page.html" class="btn btn-success btn-xs">
